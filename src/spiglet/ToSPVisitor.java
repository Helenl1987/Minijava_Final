 ...
 */
public class ToSPVisitor extends GJDepthFirst<VariType, Table> {
...
//		int tempbnew1 = ((MethodTable)argu).tempb;
//		((MethodTable)argu).tempb++;
//		AddString("MOVE TEMP " + tempbnew1 + " 0");
//		int tempbnew2 = ((MethodTable)argu).tempb;
//		((MethodTable)argu).tempb++;
//		AddString("MOVE TEMP " + tempbnew2 + " LT TEMP " + tempbnew1 + " TEMP " + t0.tempnum);
//		AddString("CJUMP TEMP " + tempbnew2 + " L" + label1);
...
//		AddString("L" + label1);
//		int tempbnew1 = methodtable.tempb;
//		methodtable.tempb++;
//		AddString("MOVE TEMP " + tempbnew1 + " 0");
//		AddString("HSTORE TEMP " + tempb4 + " 0 TEMP " + tempbnew1);
...
//		AddString("L" + label2 + " NOOP");
	...
	public VariType visit(AllocationExpression n, Table argu) {
		...
		for(int i = 0; i < classtable.total_member_method.size(); i++) {
			...
			int tempbnew1 = methodtable.tempb;
			methodtable.tempb++;
			AddString("MOVE TEMP " + tempbnew1 + " " + methodwithclassName);
			AddString("HSTORE TEMP " + tempb1 + " " + i*4 + " TEMP " + tempbnew1);
...
//			int tempbnew2 = methodtable.tempb;
//			methodtable.tempb++;
//			AddString("MOVE TEMP " + tempbnew2 + " 0");
//			AddString("HSTORE TEMP " + tempb2 + " " + (i*4+4) + " TEMP " + tempbnew2);
...
//		}
	...
	public VariType visit(NotExpression n, Table argu) {
		...
		int tempbnew1 = methodtable.tempb;
		methodtable.tempb++;
		AddString("MOVE TEMP " + tempbnew1 + " 1");
		AddString("MOVE TEMP " + tempb1 + " MINUS TEMP " + tempbnew1 + " TEMP " + t1.tempnum);
