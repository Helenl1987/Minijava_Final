...
//in typecheckvisitor, we handle the statement part and ignore the declaration part.
//most parts of typecheck is done in this visitor

public class TypeCheckVisitor extends GJDepthFirst<VariType, Table> {
	   //
